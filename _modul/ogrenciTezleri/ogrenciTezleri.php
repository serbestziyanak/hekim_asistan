...
if( $_SESSION[ 'kullanici_turu' ] == "ogrenci" ){
	$ogrenci_tezleri		= $vt->select( $SQL_tum_ogrenci_tezleri2, array( $_SESSION[ 'uzmanlik_dali_id'],$_SESSION[ 'universite_id'], $_SESSION[ 'kullanici_id'] ) )[ 2 ];
}else{
	$ogrenci_tezleri		= $vt->select( $SQL_tum_ogrenci_tezleri, array( $_SESSION[ 'uzmanlik_dali_id'],$_SESSION[ 'universite_id'] ) )[ 2 ];
}
