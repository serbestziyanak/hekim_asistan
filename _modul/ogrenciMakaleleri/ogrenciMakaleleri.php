...
$SQL_tum_ogrenci_makaleleri2 = <<< SQL
SELECT 
	os.*
	,concat(o.adi," ",o.soyadi) AS ogrenci_adi_soyadi
FROM 
...
if( $_SESSION[ 'kullanici_turu' ] == "ogrenci" ){
	$ogrenci_makaleleri			= $vt->select( $SQL_tum_ogrenci_makaleleri2, array( $_SESSION['uzmanlik_dali_id'], $_SESSION['universite_id'], $_SESSION['kullanici_id'] ) )[ 2 ];
}else{
	$ogrenci_makaleleri			= $vt->select( $SQL_tum_ogrenci_makaleleri, array( $_SESSION['uzmanlik_dali_id'], $_SESSION['universite_id'] ) )[ 2 ];
}
