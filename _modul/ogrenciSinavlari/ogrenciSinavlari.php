...
$ogrenci_sinavlari		= $vt->select( $SQL_tum_ogrenci_sinavlari, array( ) )[ 2 ];
						...
						<table id="tbl_ogrenci_sinavlari" class="table table-bordered table-hover table-sm" width = "100%" >
							...
							<tbody>
								...
								<tr oncontextmenu="fun();" class ="sinav-Tr <?php if( $ogrenci_sinav[ 'id' ] == $id ) echo $satir_renk; ?>" data-id="<?php echo $ogrenci_sinav[ 'id' ]; ?>">
									...
									<td align = "center">
										<a modul = 'ogrenciSinavlari' yetki_islem="duzenle" class = "btn btn-sm btn-warning btn-xs" href = "?modul=ogrenciSinavlari&islem=guncelle&id=<?php echo $ogrenci_sinav[ 'id' ]; ?>&universite_id=<?php echo $ogrenci_sinav[ 'universite_id' ]; ?>" >
											Düzenle
										</a>
									</td>
									<td align = "center">
						...
						<div class="card-body">
							...
							<div class="form-group">
								...
								<div class="input-group date" id="sinav_tarihi" data-target-input="nearest">
									...
									<input required type="text" data-target="#sinav_tarihi" data-toggle="datetimepicker" name="sinav_tarihi" value="<?php if( $tek_ogrenci[ 'sinav_tarihi' ] !='' ){echo date('d.m.Y',strtotime($tek_ogrenci[ 'sinav_tarihi' ] ));}//else{ echo date('d.m.Y'); } ?>" class="form-control form-control-sm datetimepicker-input" data-target="#datetimepicker1"/>
								</div>
							</div>
							<div class="form-group">
